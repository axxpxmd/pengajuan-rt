        ...
        <div class="mt-5">
            <div class="card shadow" style="border-radius: 0.7rem !important">
                <div class="card-body text-center">
                    <p class="font-weight-bold text-black fs-20 mb-4">SURAT TERVERIFIKASI</p>
                    <img src="{{ asset('images/verification.png') }}" width="200" alt="surat terverifikasi">
                    <p class="font-weight-bold fs-14 text-black mt-5 mb-1">Surat sudah disetujui oleh RT</p>
                    <p class="font-weight-bold fs-14 text-black">No Surat : {{ $data->no_surat }}</p>
                </div>
            </div>
        </div>
    </div>
